    ...
    static class Program
    {
        internal static void GeneratePixelArt(string imagePath, string dataPackPath)
        {
            try
            {
                ...
                System.IO.Directory.CreateDirectory(@dataPackPath + @"\datapacks\pixelart\data\pixelart\");
                using (System.IO.StreamWriter file =
                    new System.IO.StreamWriter(@dataPackPath + @"\datapacks\pixelart\pack.mcmeta", true))
                {
                    file.WriteLine("{\"pack\": {\"pack_format\": 5,\"description\": \"Generated by Minecraft Pixel-Art Generator\"}}");
                }
                System.IO.File.WriteAllLines(@dataPackPath + @"\datapacks\pixelart\data\pixelart\pixelart.mcfunction", commands);
